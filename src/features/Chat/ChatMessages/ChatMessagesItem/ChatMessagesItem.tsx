...
import styles from './ChatMessagesItem.module.scss';
...
export const ChatMessageItemSkeleton = ({ isMine }: { isMine?: boolean }) => {
    return (
        <>
...
export const ChatMessageItem = ({ data, sender, isMine, ...props }: IProps) => {

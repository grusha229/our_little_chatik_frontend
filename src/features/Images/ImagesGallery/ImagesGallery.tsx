...
export default function ImagesGallery({ images, start_image }: IProps) {
    ...
    return (
        <div>
            <div className={styles['image-block']}>
                <img className={styles['image']} src={images[currentIndex]?.url} />
            </div>
            {isNotSingleImage && (
                <div className={styles['navigation']}>
                    <div className={styles['navigation--item']} onClick={handlePrevClicked}>
                        Previous
                    </div>
                    <div className={styles['navigation--item']} onClick={handleNextClicked}>
                        Next
                    </div>
                </div>
            )}
